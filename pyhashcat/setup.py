...
pyhashcat_module = Extension('pyhashcat',
							include_dirs = ['hashcat/include', 'hashcat/deps/OpenCL-Headers', 'hashcat/OpenCL', 'hashcat', 'hashcat/deps/zlib', 'hashcat/deps/zlib/contrib/minizip', 'hashcat/deps/LZMA-SDK/C'],
